...
<div class="about-us content-area-8 bg-white">
  <div class="container">
    <div class="main-title">
      <h3 class="justify-content-center">Why Choose Us? </h3>
      ...
      <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
        <div class="agent-2">
          <div class="agent-photo">
            <a href="#">
              <img src="media/avatar/deogratias-alison.jpg" alt="avatar-5" class="img-fluid">
            </a>
          </div>
          <div class="agent-details">
            ...
            <ul class="social-list clearfix">
              ...
              <li><a href="https://www.twitter.com/deoalison" class="twitter"><i class="fa fa-twitter"></i></a></li>
              <li><a href="https://www.instagram.com/deesynertz" class="instagram"><i class="fa fa-instagram"></i></a></li>
              <li><a href="https://tz.linkedin.com/deogratias-alison" class="linkedin"><i class="fa fa-linkedin"></i></a></li>
            </ul>
          </div>
        </div>
      </div>
