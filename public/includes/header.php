...
<head>
  ...
  <!-- Favicon icon -->
  <link rel="shortcut icon" type="image/x-icon" href="media/various/logo.png" >
  ...
  <link rel="stylesheet" type="text/css"  href="assets/css/skins/default.css" id="style_sheet">
...
<body id="top">
  ...
  <noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PDTWJ3Z" height="0" width="0" style="display:none;visibility:hidden">
    </iframe>
  </noscript>
